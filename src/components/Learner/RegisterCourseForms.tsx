...
<div key="Description" className="relative">
  ...
  <div className="flex items-center justify-center m-auto md:m-0 bg-casbBluePrimary text-white p-2 rounded hover:bg-blue-600 cursor-pointer w-[269px]  md:w-full">
        <button
          type="submit"
          className=""
        >
