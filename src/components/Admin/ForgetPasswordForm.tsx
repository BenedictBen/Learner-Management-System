...
const ForgetPasswordForm = () => {
  ...
  >
    <h1 className="font-bold text-xl lg:text-2xl text-center md:text-left max-w-md mx-auto mb-4 text-white lg:text-black">
      Enter your email address
    </h1>

    <div className="mx-auto space-y-6 p-4 md:p-0 md:max-w-md">
