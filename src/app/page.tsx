...
<div className="home-container min-h-screen flex flex-col items-center justify-between p-4 relative z-10">
      {/* Navbar */}
      <nav className="w-full bg-white border-b border-gray-100 shadow-sm z-50">
      ...
      {/* Main Content */}
      <main className="flex-grow w-full flex flex-col items-center justify-center relative z-20">
        {/* Hero Section */}
        ...
        {/* Portal Selection */}
        <div className="w-full max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8 relative z-30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Admin Portal Card */}
            <div className="portal-card bg-gradient-to-br from-blue-50 to-white rounded-xl shadow-lg overflow-hidden border border-blue-100 transform transition-all duration-300 hover:scale-[1.02] hover:shadow-xl relative z-40">
              <div className="p-6 sm:p-8">
                ...
                <Link
                  href="/admin/login"
                  className="admin-link w-full inline-flex cursor-pointer items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 transition-all duration-200 shadow-sm"
                >
                  Go to Admin Portal
            ...
            {/* Learner Portal Card */}
            <div className="portal-card bg-gradient-to-br from-green-50 to-white rounded-xl shadow-lg overflow-hidden border border-green-100 transform transition-all duration-300 hover:scale-[1.02] hover:shadow-xl relative z-40">
              <div className="p-6 sm:p-8">
                <div className="flex items-center mb-6">
                ...
                <button
                  ...
                  className="learner-link w-full inline-flex cursor-pointer items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-emerald-600 hover:bg-emerald-700 transition-all duration-200 shadow-sm"
                >
                  {isLearnerLoading ? (
                    <>
